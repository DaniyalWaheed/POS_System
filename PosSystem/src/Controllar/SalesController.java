...
public class SalesController implements Initializable {
    ...
    public void AddSale(ActionEvent event){
            ...
            try {
                Parent root = FXMLLoader.load(getClass().getResource("/View/AddNewSale.fxml"));
    ...
    public void EditSale(ActionEvent event){
            ...
            try {
                Parent root = FXMLLoader.load(getClass().getResource("/View/EditSalesDetails.fxml"));
                Scene scene = new Scene(root);
                Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
                stage.setScene(scene);
                stage.show();
    ...
    public void DeleteSale(ActionEvent event){
            ...
            try {
                Parent root = FXMLLoader.load(getClass().getResource("/View/DeleteSalesDetails.fxml"));
                Scene scene = new Scene(root);
                Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
                stage.setScene(scene);
                stage.show();
    ...
    public void ViewAllSales(ActionEvent event){
            ...
            try {
                Parent root = FXMLLoader.load(getClass().getResource("/View/ViewAllSalesDetails.fxml"));
                Scene scene = new Scene(root);
                Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
                stage.setScene(scene);
                stage.show();
    ...
    public void SearchSale(ActionEvent event){
            ...
            try {
                Parent root = FXMLLoader.load(getClass().getResource("/View/SearchSalesDetails.fxml"));
                Scene scene = new Scene(root);
                Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
                stage.setScene(scene);
                stage.show();
