...
public class WorkerController implements Initializable {
    ...
    public void NormalWorker(ActionEvent event){
        
            try {
                Parent root = FXMLLoader.load(getClass().getResource("/View/NormalWorker.fxml"));
...
//                stage.resizableProperty().setValue(Boolean.FALSE);
    ...
    public void ContractWorker(ActionEvent event){
        
            try {
                Parent root = FXMLLoader.load(getClass().getResource("/View/ContractWorkers.fxml"));
                Scene scene = new Scene(root);
                Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
                stage.setScene(scene);
