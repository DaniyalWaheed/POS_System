 ...
 * @author daniy
 */
public class ContractWorkersController implements Initializable {
    ...
    public void AddNewWorker(ActionEvent event){
            ...
            try {
                Parent root = FXMLLoader.load(getClass().getResource("/View/AddContractWorker.fxml"));
    ...
    public void EditWorker(ActionEvent event){
            ...
            try {
                Parent root = FXMLLoader.load(getClass().getResource("/View/EditContractWorker.fxml"));
                Scene scene = new Scene(root);
                Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
                stage.setScene(scene);
                stage.show();
    ...
    public void DeleteWorker(ActionEvent event){
            ...
            try {
                Parent root = FXMLLoader.load(getClass().getResource("/View/DeleteContractWorker.fxml"));
                Scene scene = new Scene(root);
                Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
                stage.setScene(scene);
                stage.show();
    ...
    public void SearchWorker(ActionEvent event){
        
            try {
                Parent root = FXMLLoader.load(getClass().getResource("/View/SearchContractWorker.fxml"));
                Scene scene = new Scene(root);
                Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
                stage.setScene(scene);
                stage.show();
    ...
    public void CalculateSalary(ActionEvent event){
            ...
            try {
                Parent root = FXMLLoader.load(getClass().getResource("/View/CalculateSalary.fxml"));
                Scene scene = new Scene(root);
                Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
                stage.setScene(scene);
                stage.show();
    ...
    public void ViewAllWorkers(ActionEvent event){
        
            try {
                Parent root = FXMLLoader.load(getClass().getResource("/View/ViewAllContractWorkers.fxml"));
                Scene scene = new Scene(root);
                Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
                stage.setScene(scene);
                stage.show();
