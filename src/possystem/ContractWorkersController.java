...
public class ContractWorkersController implements Initializable {
    ...
    public void AddNewWorker(ActionEvent event){
            ...
            try {
                Parent root = FXMLLoader.load(getClass().getResource("AddContractWorker.fxml"));
    ...
    public void EditWorker(ActionEvent event){
            ...
            try {
                Parent root = FXMLLoader.load(getClass().getResource("EditContractWorker.fxml"));
                Scene scene = new Scene(root);
                Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
                stage.setScene(scene);
                stage.show();
    ...
    public void DeleteWorker(ActionEvent event){
            ...
            try {
                Parent root = FXMLLoader.load(getClass().getResource("DeleteContractWorker.fxml"));
                Scene scene = new Scene(root);
                Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
                stage.setScene(scene);
                stage.show();
    ...
    public void SearchWorker(ActionEvent event){
            ...
            try {
                Parent root = FXMLLoader.load(getClass().getResource("SearchContractWorker.fxml"));
                Scene scene = new Scene(root);
                Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
                stage.setScene(scene);
                stage.show();
    ...
    public void ViewAllWorkers(ActionEvent event){
            ...
            try {
                Parent root = FXMLLoader.load(getClass().getResource("ViewAllContractWorkers.fxml"));
                Scene scene = new Scene(root);
                Stage stage = (Stage)((Node)event.getSource()).getScene().getWindow();
                stage.setScene(scene);
                stage.show();
